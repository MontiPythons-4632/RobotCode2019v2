...
public class Drive extends Subsystem {
    ...
    public void gyro() {
        ...
        SmartDashboard.putNumber("xDirection", Math.round(x*100)/100);
        SmartDashboard.putNumber("yDirection", Math.round(y*100)/100);
        SmartDashboard.putNumber("zDirection", Math.round(z*100)/100);
    }
